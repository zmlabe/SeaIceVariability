...
#    return anomslp
#    
#meanslp = climo(slp,yearslens,1980,2010)    
...
#    
#    m = Basemap(projection='npstere',boundinglat=73,lon_0=270,
...
#                    values,linewidths=0.1,colors='k',
#                    linestyles='-')
#                    
...
plt.xticks(np.arange(0,year2a-year1a+3,20),
           map(str,np.arange(year1a,year2a+3,20)),fontsize=6)
